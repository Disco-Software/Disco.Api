...
import 'package:disco_app/pages/authentication/login/bloc/login_state.dart';
...
class SearchBloc extends Bloc<SearchPageEvent,SearchPageState> {
  ...
  Stream<SearchPageState> _handleFacebookLogIn(LogInFacebookEvent event) async* {
    ...
    final authResult = await _authApi.facebook(AccessTokenRequestModel(accessToken: event.accessToken));
