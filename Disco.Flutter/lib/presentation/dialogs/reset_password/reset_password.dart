...
import 'package:disco_app/dialogs/reset_password/bloc/reset_password_bloc.dart';
                  ...
                  Form(
                    ...
                    children: [
                      ...
                      const Padding(
                        ...
                        child: Text("New Password", style: TextStyle(color: DcColors.darkWhite),),
                      ),
                      TextFormField(
                      ...
                      SizedBox(
                          ...
                          child: state is SuccessPageState
                              ...
                              child: const Text(
                                "Send",
                                style: TextStyle(
                                    color: DcColors.darkWhite, fontSize: 18),
                              )))
